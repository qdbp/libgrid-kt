...
class TestRILSatCount : ScipTester() {
    ...
    fun test_binds_max_feasible() {
        ...
        with(prob) {
            ...
            with(prob.solve()) { assertObjective(3.0) }
        }
        ...
        with(prob) {
            ...
            with(prob.solve()) { assertObjective(5.0) }
        }
    }
    ...
    fun test_binds_max_infeasible() {
        ...
        with(prob) {
            ...
            with(prob.solve()) { assertInfeasible() }
        }
    }
