...
interface Potential<T: Tile> {
     ...
     *
     * In effect, this is the maximum depth of all spanning trees, since this formulation is able
     * to find the shallowest spanning tree. However, it is likely that making this value smaller
     * will worsen performance.
     *
     * This should not be set unless the height of the tree actually matters.
     */
    fun tree_depth_bound(): Int? = null
