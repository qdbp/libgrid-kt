...
/**
 * A simple "transform" that passes through the given variable as an output, but attaches a
...
class Constrained<N : Number>(x: PrimitiveLPVariable<N>, val constraints: List<LPConstraint>) :
    ...
    override fun render_auxiliaries(ctx: MipContext): List<LPRenderable> = constraints
