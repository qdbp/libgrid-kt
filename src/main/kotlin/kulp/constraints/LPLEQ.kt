...
class LPLEQ(override val name: String, lhs: LPExprLike, rhs: LPExprLike = LPAffineExpression()) : LPConstraint {
    constructor(name: String, lhs: Number, rhs: LPExprLike) : this(name, LPAffineExpression(lhs), rhs)
    constructor(name: String, lhs: LPExprLike, rhs: Number) : this(name, lhs, LPAffineExpression(rhs))
